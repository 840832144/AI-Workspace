...
def build_javascript(mode: str) -> str:
    if mode == "stability":
        return r"""
        'use strict';
...
def main() -> None:
    parser = argparse.ArgumentParser(description="TASK-0024 scoped Cash Frenzy inbound probe")
    parser.add_argument("--session-dir", required=True)
    parser.add_argument("--endpoint", default="127.0.0.1:27043")
    parser.add_argument("--duration", type=int, default=120)
    parser.add_argument("--mode", choices=("stability", "lua"), default="stability")
    ...
    counts = {"events": 0, "lua_pcall_args": 0, "scope_summaries": 0, "errors": 0}
    stopping = False
    finishing = False
    ...
    script = session.create_script(build_javascript(args.mode))
