...
合并后日常使用 `main`，无需另外克隆 `cr_design`。先读 [全局模板](bootstrap/AGENTS.md)、[根规则](AGENTS.md)、[CR 入口](projects/cr/README.md)。迁移来源、清单与回滚见 [迁移报告](docs/migrations/CR-MIGRATION-20260916.md)。
