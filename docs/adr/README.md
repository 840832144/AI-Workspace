...
- [`ADR-0006-Task-Identity-and-Allocation.md`](ADR-0006-Task-Identity-and-Allocation.md) — 提议采用全局 `TASK-XXXX` + `project_key` / alias，并以可重建 Registry、latest-main gate 和原子 reservation 治理分配；等待 ChatGPT Review。
