...
RFC 用于需要讨论、影响多个组成部分或改变 AI 协作体系边界的提案。

| RFC | 标题 | 状态 |
| --- | --- | --- |
| [RFC-0001](RFC-0001-AI-Workspace-Charter.md) | AI-Workspace Charter | Accepted |
...
| [RFC-0005](RFC-0005-CR-Subtree-Public-Migration.md) | CR public subtree 迁移 | Scope approved / Round 1 Accepted; merge pending |
