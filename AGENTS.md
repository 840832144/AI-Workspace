...
- Inherit cross-project Tool Discovery and shared Document Assistant rules from Global Codex guidance. Do not turn this repository into a runtime tool catalog, installer, endpoint registry, credential store, or connection-status source.
