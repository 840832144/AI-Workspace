...
- 先读本项目 [`STATUS.md`](STATUS.md)、[`MEMORY.md`](MEMORY.md) 和外部仓库对应 module dossier。
...
2. **Evidence routing — ChatGPT**：从 README 选择 dossier/schema/session entry，标注 Confirmed、Hypothesis、Derived。
