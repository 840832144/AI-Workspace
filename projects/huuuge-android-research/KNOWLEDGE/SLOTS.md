...
| --- | --- | --- | --- | --- |
| [`slots` — Slots / Lobby / Spin / Jackpot](https://github.com/840832144/huuuge-android-research/blob/0590c2c37a0aa83b824920fa884f9f67007d3dcb/artifacts/module_catalog/slots.md) | L3 Runtime Observed | Runtime P 288 + X 1；Schema 90M/32E；Schema hint ZPK 17 | 90/100 — substantial live structure | 先复用现有 29 Spin pairs；Review 后选择代表性机器、bet change 和自然 feature/free-spin/jackpot 状态补证，或定义首个 normalized gameplay Extractor |
...
本页等级遵循 [`Huuuge Evidence Standard`](../../../standards/HUUUGE_EVIDENCE_STANDARD.md)；L3 只适用于已记录 Runtime 样本的声明范围，不代表已完成 L4 多源验证。
