...
def generated_current_state(root: Path) -> str:
    ...
    lines.extend(
        [
            ...
            "- `handoff/CHATGPT.md`",
            "- `handoff/CODEX.md`",
            "- CR 项目：`projects/cr/README.md`、`projects/cr/AGENTS.md`、`projects/cr/STATUS.md`",
            "- CR Skill 路由：`.agents/skills/cr-project/SKILL.md`；正文在 `projects/cr/.agents/skills/`",
            "- 仅一个 AI-Workspace 克隆；CR 日期附件与公司 SVN 当前配置分别核验，不与 101 混用。",
            "",
